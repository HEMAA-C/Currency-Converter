# Currency-Converter
A user-friendly currency converter web application developed using HTML, CSS, Javascript, and real-time exchange rate API.

## Features
- Real-time exchanfe rates from a reliable API
